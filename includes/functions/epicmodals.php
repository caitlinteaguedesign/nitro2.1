...
var supermodal = (function(){
   ...
   */
   ...
   $(document).ready(function(){
      ...
      $('#supermodal-overlay').click(function(){ supermodal.close(); });
   });
   ...
   method.showDiv = function (settings) {
    ...
    method.open = function (settings) 
	{
      ...
      $modal.css({
	   ...
	   {
		   if(typeof(supermodalTemplate)!='undefined' && supermodalTemplate != null) settings.template=supermodalTemplate;
   ...
   method.fadeOut = function (settings) 
   {
	   ...
	   setTimeout(function(){ method.close(); },(delayTime+fadeTime));	// Make sure everything else closes once finished
   };
